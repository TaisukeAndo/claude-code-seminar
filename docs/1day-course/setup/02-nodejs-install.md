...
→ [③ Claude Code CLI インストール](/1day-course/setup/03-claude-code-install) に進んでください。
...
Node.js のインストールが完了したら [③ Claude Code CLI インストール](/1day-course/setup/03-claude-code-install) に進んでください。
